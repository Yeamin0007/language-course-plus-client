    ...
    return (
        ...
        <div className='text-center text-white border border-2 border-info my-3 py-3 rounded-3'>
          ...
          <div className='text-center text-white border border-2 border-secondary my-3 py-3 rounded-3'>
              <h2 className='text-warning fw-bold'>Why are you using firebase? What other options do you have to implement authentication?</h2>
          ...
          <div className='text-center text-white border border-2 border-info my-3 py-3 rounded-3'>
              <h2 className='text-info fw-bold'>What is Node? How does Node work?</h2>
